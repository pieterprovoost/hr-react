    ...
    <div className="App h-100 d-flex flex-column">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <p>hagelradar.be visualiseert de actuele kans op hagel voor de Benelux op basis van gegevens van de neerslagradar van het <a rel="noreferrer" class="text-black" href="https://www.knmi.nl/" target="_blank">KNMI</a> en meldingen van gebruikers van de <a rel="noreferrer" class="text-black" href="https://www.meteo.be/" target="_blank">KMI</a> app.</p>
